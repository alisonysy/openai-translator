            ...
            for content in page.contents:
                if content.status:
                    if content.content_type == ContentType.TEXT:
                        ...
                        pdf_table_cont = [table.columns.tolist()]
                        pdf_table_body = table.values.tolist()
                        pdf_table_cont.extend(pdf_table_body)
                        LOG.debug(f'Writing output of table: {pdf_table_cont}, type: {type(pdf_table_cont)}')
                        pdf_table = Table(pdf_table_cont)
